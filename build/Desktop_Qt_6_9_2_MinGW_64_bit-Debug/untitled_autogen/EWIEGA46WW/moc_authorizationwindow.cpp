...
template <> constexpr inline auto AuthorizationWindow::qt_create_metaobjectdata<qt_meta_tag_ZN19AuthorizationWindowE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<AuthorizationWindow, qt_meta_tag_ZN19AuthorizationWindowE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject AuthorizationWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19AuthorizationWindowE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19AuthorizationWindowE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN19AuthorizationWindowE_t>.metaTypes,
    nullptr
} };
...
void *AuthorizationWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19AuthorizationWindowE_t>.strings))
